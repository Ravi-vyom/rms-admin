        ...
        <>
            <Box sx={{
                ...
                <div style={{
                    ...
                    <TitleWithButton title="Flat" buttonText="Create" onClick={() => setOpen(true)} />
                        ...
                        <Grid container spacing={4}>
                            <Grid size={{ xs: 6, md: 12 }}>
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue=""
                                    rules={{ required: "Flour is required" }}
                                    render={({ field }) => (
                                        <FormControl fullWidth error={!!errors.Flour}>
                                            <InputLabel id="flour-label">Flour</InputLabel>
                                            <Select
                                                labelId="flour-label"
                                                id="flour-label"
                                                label="Building"
                                            ...
                                            <FormHelperText>{errors.Flour?.message}</FormHelperText>
                                        </FormControl>
                                    )}
                                />
                            </Grid>
